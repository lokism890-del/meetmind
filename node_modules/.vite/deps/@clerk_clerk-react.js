...
//#region node_modules/@clerk/clerk-react/dist/esm/chunk-XTU7I5IS.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/polyfills.js
if (typeof window !== "undefined" && !window.global) window.global = typeof global === "undefined" ? window : global;
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-TETGTEI2.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-IAZRYRAH.mjs
...
function parsePublishableKey(key) {
	...
	if (!frontendApi.endsWith("$")) return null;
...
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-NDCDZYN6.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-IC4FGZI3.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-VN4YMSVR.mjs
...
var MagicLinkErrorCode = new Proxy({
	Expired: "expired",
	Failed: "failed"
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/errors.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/childrenUtils.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/errorThrower.js
var errorThrower = buildErrorThrower({ packageName: "@clerk/react" });
function __internal__setErrorThrowerOptions(options) {
	errorThrower.setMessages(options).setPackageName(options);
}
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/isConstructor.js
function isConstructor(f) {
	return typeof f === "function";
}
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-AOO6TJNL.mjs
var NO_DOCUMENT_ERROR = "loadScript cannot be called when document does not exist";
var NO_SRC_ERROR = "loadScript cannot be called without a src";
async function loadScript(src = "", opts) {
	const { async, defer, beforeLoad, crossOrigin } = opts || {};
	return new Promise((resolve, reject) => {
		if (!src) reject(NO_SRC_ERROR);
		if (!document || !document.body) reject(NO_DOCUMENT_ERROR);
...
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-MHVPBPEZ.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-BX6URPWV.mjs
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/isDevOrStageUrl.js
var { isDevOrStagingUrl } = createDevOrStagingUrlCache();
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/versionSelector.js
var versionSelector = (clerkJSVersion) => {
	if (clerkJSVersion) return clerkJSVersion;
	const prereleaseTag = getPrereleaseTag("4.32.5");
	if (prereleaseTag) {
		if (prereleaseTag === "snapshot") return "4.73.14";
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/loadClerkJsScript.js
var FAILED_TO_LOAD_ERROR = "Clerk: Failed to load Clerk";
var loadClerkJsScript = (opts) => {
	const { frontendApi, publishableKey } = opts;
	if (!publishableKey && !frontendApi) errorThrower.throwMissingPublishableKeyError();
...
var clerkJsScriptUrl = (opts) => {
	...
	else if (domain && !isDevOrStagingUrl(((_a = parsePublishableKey(publishableKey)) == null ? void 0 : _a.frontendApi) || frontendApi || "")) scriptHost = addClerkPrefix(domain);
	else scriptHost = ((_b = parsePublishableKey(publishableKey)) == null ? void 0 : _b.frontendApi) || frontendApi || "";
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/useMaxAllowedInstancesGuard.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/useCustomElementPortal.js
...
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-5QXIOV6T.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-TRWMHODU.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/chunk-LJ4R7M7R.mjs
function inBrowser() {
...
//#endregion
//#region node_modules/@clerk/shared/dist/index.mjs
var logErrorInDevMode = (message) => {
	if (isDevelopmentEnvironment()) console.error(message);
};
//#endregion
...
//#endregion
//#region node_modules/swr/_internal/dist/index.mjs
var noop = () => {};
var UNDEFINED = noop();
var OBJECT = Object;
...
async function internalMutate(...args) {
	...
	async function mutateByKey(_k) {
		...
		if (populateCache) {
			if (!error) {
				if (isFunction(populateCache)) data = populateCache(data, committedData);
				set({
					data,
					error: UNDEFINED,
					_c: UNDEFINED
...
setupDevTools();
//#endregion
//#region node_modules/swr/core/dist/index.mjs
...
var useSWRHandler = (_key, fetcher, config) => {
			...
			if (!currentConfig.isPaused()) {
				...
				if (shouldStartNewRequest && callbackSafeguard()) {
					...
					if (shouldRetryOnError === true || isFunction(shouldRetryOnError) && shouldRetryOnError(err)) {
						if (isActive()) currentConfig.onErrorRetry(err, key, currentConfig, (_opts) => {
							const revalidators = EVENT_REVALIDATORS[key];
							if (revalidators && revalidators[0]) revalidators[0](constants.ERROR_REVALIDATE_EVENT, _opts);
						}, {
	...
	useIsomorphicLayoutEffect(() => {
		...
		const onRevalidate = (type, opts = {}) => {
			...
			} else if (type == constants.MUTATE_EVENT) return revalidate();
			else if (type == constants.ERROR_REVALIDATE_EVENT) return revalidate(opts);
		};
		...
		setCache({ _k: fnArg });
		if (shouldDoInitialRevalidation) if (isUndefined(data) || IS_SERVER) softRevalidate();
...
var SWRConfig = OBJECT.defineProperty(SWRConfig$1, "defaultValue", { value: defaultConfig });
/**
...
//#endregion
//#region node_modules/swr/infinite/dist/index.mjs
...
var infinite = (useSWRNext) => (getKey, fn, config) => {
	...
	const mutate = (0, import_react.useCallback)(function(data, opts) {
		...
		if (shouldRevalidate) if (!isUndefined(data)) set({ _i: false });
		else set({ _i: true });
...
var OrganizationProvider = ({ children, organization, lastOrganizationMember, lastOrganizationInvitation, swrConfig }) => {
	return /* @__PURE__ */ import_react.createElement(SWRConfig, { value: swrConfig }, /* @__PURE__ */ import_react.createElement(OrganizationContextInternal.Provider, { value: { value: {
		organization,
...
var useWithSafeValues = (params, defaultValues) => {
	...
	const initialPageRef = (0, import_react.useRef)(shouldUseDefaults ? defaultValues.initialPage : (_a = params == null ? void 0 : params.initialPage) != null ? _a : defaultValues.initialPage);
	const pageSizeRef = (0, import_react.useRef)(shouldUseDefaults ? defaultValues.pageSize : (_b = params == null ? void 0 : params.pageSize) != null ? _b : defaultValues.pageSize);
	const newObj = {};
...
var usePagesOrInfinite = (params, fetcher, options, cacheKeys) => {
	...
	const [paginatedPage, setPaginatedPage] = (0, import_react.useState)((_a = params.initialPage) != null ? _a : 1);
	const initialPageRef = (0, import_react.useRef)((_b = params.initialPage) != null ? _b : 1);
	const pageSizeRef = (0, import_react.useRef)((_c = params.pageSize) != null ? _c : 10);
	...
	const { data: swrData, isValidating: swrIsValidating, isLoading: swrIsLoading, error: swrError, mutate: swrMutate } = useSWR(!triggerInfinite && !!fetcher && enabled ? pagesCacheKey : null, (cacheKeyParams) => {
	...
	const { data: swrInfiniteData, isLoading: swrInfiniteIsLoading, isValidating: swrInfiniteIsValidating, error: swrInfiniteError, size, setSize, mutate: swrInfiniteMutate } = useSWRInfinite((pageIndex) => {
		if (!triggerInfinite || !enabled) return null;
		return {
			...params,
			...cacheKeys,
	...
	const data = (0, import_react.useMemo)(() => {
		var _a2, _b2;
		if (triggerInfinite) return (_a2 = swrInfiniteData == null ? void 0 : swrInfiniteData.map((a) => a == null ? void 0 : a.data).flat()) != null ? _a2 : [];
	...
	const count = (0, import_react.useMemo)(() => {
		var _a2, _b2;
		if (triggerInfinite) return ((_a2 = swrInfiniteData == null ? void 0 : swrInfiniteData[(swrInfiniteData == null ? void 0 : swrInfiniteData.length) - 1]) == null ? void 0 : _a2.total_count) || 0;
...
var useOrganization = (params) => {
	...
	if (invitationListParams) deprecated("invitationList in useOrganization", "Use the `invitations` property and return value instead.");
	const { data: invitationList, isValidating: isInvitationsLoading, mutate: mutateInvitationList } = useSWR(shouldFetch && invitationListParams ? cacheKey("invites", organization, lastOrganizationInvitation, invitationListParams) : null, pendingInvitations);
	if (membershipListParams) deprecated("membershipList in useOrganization", "Use the `memberships` property and return value instead.");
	const { data: membershipList, isValidating: isMembershipsLoading, mutate: mutateMembershipList } = useSWR(shouldFetch && membershipListParams ? cacheKey("memberships", organization, lastOrganizationMember, membershipListParams) : null, currentOrganizationMemberships);
	...
	return {
		...
		invitationList,
		unstable__mutate: () => {
			mutateMembershipList();
			mutateInvitationList();
		},
		domains,
		membershipRequests,
		memberships,
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/contexts/IsomorphicClerkContext.js
var [IsomorphicClerkContext, useIsomorphicClerkContext] = [ClerkInstanceContext, useClerkInstanceContext];
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/contexts/assertHelpers.js
function assertWrappedByClerkProvider(contextVal) {
	if (!contextVal) throw new Error(noClerkProviderError);
}
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/contexts/StructureContext.js
var StructureContextStates = Object.freeze({
	noGuarantees: Object.freeze({ guaranteedLoaded: false }),
	guaranteedLoaded: Object.freeze({ guaranteedLoaded: true })
});
var StructureContext = import_react.createContext(void 0);
StructureContext.displayName = "StructureContext";
var useStructureContext = () => {
	const structureCtx = import_react.useContext(StructureContext);
	assertWrappedByClerkProvider(structureCtx);
	return structureCtx;
};
var LoadedGuarantee = ({ children }) => {
	if (useStructureContext().guaranteedLoaded) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children);
	return /* @__PURE__ */ import_react.createElement(StructureContext.Provider, { value: StructureContextStates.guaranteedLoaded }, children);
};
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/components/withClerk.js
var withClerk = (Component, displayName) => {
	...
	const HOC = (props) => {
		...
		return /* @__PURE__ */ import_react.createElement(LoadedGuarantee, null, /* @__PURE__ */ import_react.createElement(Component, {
			...props,
			clerk
		}));
	};
...
var WithClerk = ({ children }) => {
	const clerk = useIsomorphicClerkContext();
	if (typeof children !== "function") throw new Error(hocChildrenNotAFunctionError);
	if (!clerk.loaded) return null;
	return /* @__PURE__ */ import_react.createElement(LoadedGuarantee, null, children(clerk));
};
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/components/uiComponents.js
...
var Portal = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		this.portalRef = import_react.createRef();
	}
	componentDidUpdate(prevProps) {
		var _a, _b, _c, _d;
		if (!isMountProps(prevProps) || !isMountProps(this.props)) return;
		if (prevProps.props.appearance !== this.props.props.appearance || ((_b = (_a = prevProps.props) == null ? void 0 : _a.customPages) == null ? void 0 : _b.length) !== ((_d = (_c = this.props.props) == null ? void 0 : _c.customPages) == null ? void 0 : _d.length)) this.props.updateProps({
	...
	render() {
		var _a, _b;
		return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement("div", { ref: this.portalRef }), isMountProps(this.props) && ((_b = (_a = this.props) == null ? void 0 : _a.customPagesPortals) == null ? void 0 : _b.map((portal, index) => (0, import_react.createElement)(portal, { key: index }))));
	}
};
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/useCustomPages.js
...
var useCustomPages = ({ children, LinkComponent, PageComponent, reorderItemsLabels, componentName }) => {
	...
	import_react.Children.forEach(children, (child) => {
		if (!isThatComponent(child, PageComponent) && !isThatComponent(child, LinkComponent)) {
			if (child) logErrorInDevMode(customPagesIgnoredComponent(componentName));
			return;
		}
		const { props } = child;
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/isomorphicClerk.js
...
var _IsomorphicClerk = class _IsomorphicClerk {
	constructor(options) {
		...
		this.buildSignInUrl = (opts) => {
			...
			if (this.clerkjs && __privateGet(this, _loaded)) return callback();
		...
		this.buildHomeUrl = () => {
			...
			if (this.clerkjs && __privateGet(this, _loaded)) return callback();
			else this.premountMethodCalls.set("buildHomeUrl", callback);
		};
		...
		this.handleUnauthenticated = () => {
			...
			if (this.clerkjs && __privateGet(this, _loaded)) callback();
		...
		*/
		...
		this.openSignIn = (props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.openSignIn(props);
			else this.preopenSignIn = props;
		};
		this.closeSignIn = () => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.closeSignIn();
			else this.preopenSignIn = null;
		};
		this.openGoogleOneTap = (props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.openGoogleOneTap(props);
			else this.preopenOneTap = props;
		};
		this.closeGoogleOneTap = () => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.closeGoogleOneTap();
			else this.preopenOneTap = null;
		};
		this.openUserProfile = (props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.openUserProfile(props);
			else this.preopenUserProfile = props;
		};
		this.closeUserProfile = () => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.closeUserProfile();
			else this.preopenUserProfile = null;
		};
		this.openOrganizationProfile = (props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.openOrganizationProfile(props);
			else this.preopenOrganizationProfile = props;
		};
		this.closeOrganizationProfile = () => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.closeOrganizationProfile();
			else this.preopenOrganizationProfile = null;
		};
		this.openCreateOrganization = (props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.openCreateOrganization(props);
			else this.preopenCreateOrganization = props;
		};
		this.closeCreateOrganization = () => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.closeCreateOrganization();
			else this.preopenCreateOrganization = null;
		};
		this.openSignUp = (props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.openSignUp(props);
			else this.preopenSignUp = props;
		};
		this.closeSignUp = () => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.closeSignUp();
			else this.preopenSignUp = null;
		};
		this.mountSignIn = (node, props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.mountSignIn(node, props);
			else this.premountSignInNodes.set(node, props);
		};
		this.unmountSignIn = (node) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.unmountSignIn(node);
			else this.premountSignInNodes.delete(node);
		};
		this.mountSignUp = (node, props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.mountSignUp(node, props);
			else this.premountSignUpNodes.set(node, props);
		};
		this.unmountSignUp = (node) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.unmountSignUp(node);
			else this.premountSignUpNodes.delete(node);
		};
		this.mountUserProfile = (node, props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.mountUserProfile(node, props);
			else this.premountUserProfileNodes.set(node, props);
		};
		this.unmountUserProfile = (node) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.unmountUserProfile(node);
			else this.premountUserProfileNodes.delete(node);
		};
		this.mountOrganizationProfile = (node, props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.mountOrganizationProfile(node, props);
			else this.premountOrganizationProfileNodes.set(node, props);
		};
		this.unmountOrganizationProfile = (node) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.unmountOrganizationProfile(node);
			else this.premountOrganizationProfileNodes.delete(node);
		};
		this.mountCreateOrganization = (node, props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.mountCreateOrganization(node, props);
			else this.premountCreateOrganizationNodes.set(node, props);
		};
		this.unmountCreateOrganization = (node) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.unmountCreateOrganization(node);
			else this.premountCreateOrganizationNodes.delete(node);
		};
		this.mountOrganizationSwitcher = (node, props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.mountOrganizationSwitcher(node, props);
			else this.premountOrganizationSwitcherNodes.set(node, props);
		};
		this.unmountOrganizationSwitcher = (node) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.unmountOrganizationSwitcher(node);
			else this.premountOrganizationSwitcherNodes.delete(node);
		};
		this.mountOrganizationList = (node, props) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.mountOrganizationList(node, props);
			else this.premountOrganizationListNodes.set(node, props);
		};
		this.unmountOrganizationList = (node) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.unmountOrganizationList(node);
			else this.premountOrganizationListNodes.delete(node);
		};
		this.mountUserButton = (node, userButtonProps) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.mountUserButton(node, userButtonProps);
			else this.premountUserButtonNodes.set(node, userButtonProps);
		};
		this.unmountUserButton = (node) => {
			if (this.clerkjs && __privateGet(this, _loaded)) this.clerkjs.unmountUserButton(node);
		...
		this.addListener = (listener) => {
			...
			if (this.clerkjs) return callback();
			else {
		...
		this.handleRedirectCallback = (params) => {
			...
			if (this.clerkjs && __privateGet(this, _loaded)) (_a = callback()) == null || _a.catch(() => {});
		...
		*/
		...
		this.authenticateWithGoogleOneTap = async (params) => {
			return (await __privateMethod(this, _waitForClerkJS, waitForClerkJS_fn).call(this)).authenticateWithGoogleOneTap(params);
		};
	...
	static getOrCreateInstance(options) {
		if (!inBrowser() || !__privateGet(this, _instance) || options.Clerk && __privateGet(this, _instance).Clerk !== options.Clerk) __privateSet(this, _instance, new _IsomorphicClerk(options));
	...
	get domain() {
		...
		if (typeof __privateGet(this, _domain) === "function") throw new Error(unsupportedNonBrowserDomainOrProxyUrlFunction);
	...
	get proxyUrl() {
		...
		if (typeof __privateGet(this, _proxyUrl) === "function") throw new Error(unsupportedNonBrowserDomainOrProxyUrlFunction);
	...
	get isSatellite() {
		...
		if (typeof this.options.isSatellite === "function") throw new Error(unsupportedNonBrowserDomainOrProxyUrlFunction);
		return false;
	}
	async loadClerkJS() {
		var _a, _b, _c;
		if (this.mode !== "browser" || __privateGet(this, _loaded)) return;
		...
		try {
			...
			if (((_b = global.Clerk) == null ? void 0 : _b.loaded) || ((_c = global.Clerk) == null ? void 0 : _c.isReady())) return this.hydrateClerkJS(global.Clerk);
			return;
		} catch (err) {
			throw err;
		}
...
waitForClerkJS_fn = function() {
	return new Promise((resolve) => {
		if (__privateGet(this, _loaded)) resolve(this.clerkjs);
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/utils/deriveState.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/contexts/AuthContext.js
var [AuthContext, useAuthContext] = createContextAndHook("AuthContext");
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/contexts/ClerkContextProvider.js
function ClerkContextProvider(props) {
	const { isomorphicClerkOptions, initialState, children } = props;
	const { isomorphicClerk: clerk, loaded: clerkLoaded } = useLoadedIsomorphicClerk(isomorphicClerkOptions);
	if (isomorphicClerkOptions.frontendApi) deprecated("frontendApi", "Use `publishableKey` instead.");
	...
	const clerkCtx = import_react.useMemo(() => ({ value: clerk }), [clerkLoaded]);
	...
	return /* @__PURE__ */ import_react.createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, /* @__PURE__ */ import_react.createElement(ClientContext.Provider, { value: clientCtx }, /* @__PURE__ */ import_react.createElement(SessionContext.Provider, { value: sessionCtx }, /* @__PURE__ */ import_react.createElement(OrganizationProvider, { ...organizationCtx.value }, /* @__PURE__ */ import_react.createElement(AuthContext.Provider, { value: authCtx }, /* @__PURE__ */ import_react.createElement(UserContext.Provider, { value: userCtx }, children))))));
}
var useLoadedIsomorphicClerk = (options) => {
	const [loaded, setLoaded] = import_react.useState(false);
	const isomorphicClerk = import_react.useMemo(() => IsomorphicClerk.getOrCreateInstance(options), []);
	import_react.useEffect(() => {
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/contexts/ClerkProvider.js
__internal__setErrorThrowerOptions({ packageName: "@clerk/clerk-react" });
function ClerkProviderBase(props) {
	...
	if (!userInitialisedClerk) {
		...
		else if (!publishableKey && frontendApi && !isLegacyFrontendApiKey(frontendApi)) errorThrower.throwInvalidFrontendApiError({ key: frontendApi });
	}
	return /* @__PURE__ */ import_react.createElement(StructureContext.Provider, { value: StructureContextStates.noGuarantees }, /* @__PURE__ */ import_react.createElement(ClerkContextProvider, {
		initialState,
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/useUser.js
function useUser() {
	const user = useUserContext();
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/utils.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/useAuth.js
var useAuth = () => {
	...
	const has = (0, import_react.useCallback)((params) => {
		if (!(params == null ? void 0 : params.permission) && !(params == null ? void 0 : params.role)) throw new Error(useAuthHasRequiresRoleOrPermission);
		if (!orgId || !userId || !orgRole || !orgPermissions) return false;
		if (params.permission) return orgPermissions.includes(params.permission);
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/useSession.js
var useSession = () => {
	const session = useSessionContext();
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/useClerk.js
var useClerk = () => {
	return useIsomorphicClerkContext();
};
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/useSignIn.js
var useSignIn = () => {
	const isomorphicClerk = useIsomorphicClerkContext();
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/useSignUp.js
var useSignUp = () => {
	const isomorphicClerk = useIsomorphicClerkContext();
	const client = useClientContext();
	if (!client) return {
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/useSessionList.js
var useSessionList = () => {
	const isomorphicClerk = useIsomorphicClerkContext();
	const client = useClientContext();
	if (!client) return {
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/useMagicLink.js
function useMagicLink(resource) {
	deprecated("useMagicLink", "Use `useEmailLink` instead.");
	const { startMagicLinkFlow, cancelMagicLinkFlow } = import_react.useMemo(() => resource.createMagicLinkFlow(), [resource]);
	import_react.useEffect(() => {
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/hooks/useEmailLink.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/components/controlComponents.js
var SignedIn = ({ children }) => {
	const { userId } = useAuthContext();
	if (userId) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children);
	return null;
};
var SignedOut = ({ children }) => {
	const { userId } = useAuthContext();
	if (userId === null) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children);
	return null;
};
var ClerkLoaded = ({ children }) => {
	if (!useIsomorphicClerkContext().loaded) return null;
	return /* @__PURE__ */ import_react.createElement(LoadedGuarantee, null, children);
};
...
var Protect = ({ children, fallback, ...restAuthorizedParams }) => {
	...
	const unauthorized = /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, fallback != null ? fallback : null);
	const authorized = /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children);
...
var MultisessionAppSupport = ({ children }) => {
	const session = useSessionContext();
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, { key: session ? session.id : "no-users" }, children);
};
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/components/withUser.js
...
var WithUser = ({ children }) => {
	...
	if (typeof children !== "function") throw new Error(hocChildrenNotAFunctionError);
	if (!user) return null;
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children(user));
};
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/components/withSession.js
...
var WithSession = ({ children }) => {
	...
	if (typeof children !== "function") throw new Error(hocChildrenNotAFunctionError);
	if (!session) return null;
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children(session));
};
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/components/SignInButton.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/components/SignUpButton.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/components/SignOutButton.js
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/esm/components/SignInWithMetamaskButton.js
...
//#endregion
export { AuthenticateWithRedirectCallback, ClerkLoaded, ClerkLoading, ClerkProvider, CreateOrganization, EmailLinkErrorCode, GoogleOneTap, MagicLinkErrorCode, MultisessionAppSupport, OrganizationList, OrganizationProfile, OrganizationSwitcher, Protect, RedirectToCreateOrganization, RedirectToOrganizationProfile, RedirectToSignIn, RedirectToSignUp, RedirectToUserProfile, SignIn, SignInButton, SignInWithMetamaskButton, SignOutButton, SignUp, SignUpButton, SignedIn, SignedOut, UserButton, UserProfile, WithClerk, WithSession, WithUser, __internal__setErrorThrowerOptions, isClerkAPIResponseError, isEmailLinkError, isKnownError, isMagicLinkError, isMetamaskError, useAuth, useClerk, useEmailLink, useMagicLink, useOrganization, useOrganizationList, useOrganizations, useSession, useSessionList, useSignIn, useSignUp, useUser, withClerk, withSession, withUser };
